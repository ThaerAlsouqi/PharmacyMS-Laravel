        ...
        if($request->ajax()){
            ...
            return DataTables::of($categories)
                    ...
                    ->addColumn('action',function ($row){
                        ...
                        // if u want to restrict access to edit and delete buttons based on permissions but first add the permissions ,'edit-category', to the tables then to the roles 
